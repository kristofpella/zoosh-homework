...
export const WIKIPEDIA_SEARCH_URL = 'https://en.wikipedia.org/w/api.php?origin=*&action=query&format=json&prop=info&redirects=1&list=search&srsearch=';

// On this URL we will perform the search based on the exact Wikipedia title
export const WIKIPEDIA_FETCH_URL = 'https://en.wikipedia.org/w/api.php?origin=*&format=json&action=query&prop=extracts&exintro&explaintext&redirects=1&titles='
